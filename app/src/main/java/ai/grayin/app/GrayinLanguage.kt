...
private val EnglishStrings = GrayinStrings(
    ...
    localGemmaModelInvalidFile = "Select a non-empty .litertlm model file.",
...
private val KoreanStrings = EnglishStrings.copy(
    ...
    localGemmaModelInvalidFile = "비어 있지 않은 .litertlm 모델 파일을 선택하세요.",
...
private val JapaneseStrings = EnglishStrings.copy(
    ...
    localGemmaModelInvalidFile = "空ではない .litertlm モデルファイルを選択してください。",
